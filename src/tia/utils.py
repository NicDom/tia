...
AnyObject = TypeVar("AnyObject", bound=object)
...
def orjson_load(filename: FilePath) -> Dict[Any, Any]:
    ...
    Returns:
        Dict[Any, Any]: A dictionary with the data of the file.
    """
...
def file2class(cls: AnyObject, file: FilePath) -> AnyObject:
...
def delete_file(filepath: str) -> Optional[str]:
